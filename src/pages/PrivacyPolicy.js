...
const PrivacyPolicy = () => {
    return (
        <div>
            ...
            <Card raised={true}>
                <CardContent>
                    <p>Your privacy is important to us. It is our policy to respect your privacy regarding any information we may collect from you through our app, Count my breaths.</p>
